...
exports.feishuUrls = exports.feishuSelectors = void 0;
exports.feishuAppSubpageUrls = feishuAppSubpageUrls;
exports.feishuSelectors = {
    consoleEntryButtons: [
        'a:has-text("控制台")',
        'button:has-text("控制台")',
        'a:has-text("开发者后台")',
    ...
    saveButton: 'button:has-text("保存"), button:has-text("Save"), button:has-text("创建"), button:has-text("Create")',
    appIdText: 'text=/App ID|应用 ID|应用ID/i, [data-testid="app-id"], code:has-text("cli_")',
    appSecretText: 'text=/App Secret|应用 Secret|应用密钥/i, [data-testid="app-secret"], code:has-text("secret_")',
    createAppButtons: [
...
exports.feishuUrls = {
    ...
    docReference: "https://open.feishu.cn/document/develop-a-card-interactive-bot/faqs?lang=zh-CN",
};
/** 直达应用子页（多路径容错，适配不同控制台版本） */
function feishuAppSubpageUrls(appId) {
    const id = appId.trim();
